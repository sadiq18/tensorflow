...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 23 10:53:06 2018
...
class Net(object):
    ...
    def __init__(self,commom_params,net_params):
        """
    ...
    def _variable_on_cpu(self,name,shape,initializer,pretrain=True,train=True):
        """
            ...
            Args:
                ...
                shape: list of ints
                initializer: initilizer of Variable
    ...
    def _variable_with_weight_decay(self, name, shape, stddev, wd, pretrain=True, train=True):
        """
            ...
            Note that the Variable is initilized with truncated normal distribution
    ...
    def inference(self, images):
        """
            ...
            Return:
                predicts:
                    4-D tensor [batch_size, cell_size, cell_size, num_classes + 5 * boxes_per_cell]
        """
    ...
    def loss(self, predicts, labels, objects_num):
        """
            ...
            Args:
                ...
                labels: 3-D tensor of [batch_size, max_objetcs, 5]
                objetcs_num: 1-D tensor [batch_size]
        """
